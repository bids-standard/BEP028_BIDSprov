...
Started at Fri 4 May 08:20:29 BST 2018
## Feat main script  
...
/bin/mkdir -p /storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/TEST/nidmresults-examples/fsl_motion_reg_der.feat/reg
...
paradigm.getDesignMatrix().Ncols()=26
sizeTS=104
numTS=38352
...
/usr/local/packages/fsl-5.0.10/bin/smoothest -d 78   -m mask -r stats/res4d > stats/smoothness
...
zstat1: DLH=0.726305 VOLUME=38352 RESELS=6.39327
...
3.093412 5.467648 
Rendering using zmin=3.093412 zmax=5.467648

/usr/local/packages/fsl-5.0.10/bin/overlay 1 0 example_func -a thresh_zstat1 3.093412 5.467648 rendered_thresh_zstat1
