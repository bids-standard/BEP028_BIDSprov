...
TASKS = {'cfg_basicio.file_dir.file_ops.file_move._1': [
    ...
    'eoptions.quality = 0.9;', 'eoptions.sep = 4;', 'eoptions.fwhm = 5;', 'eoptions.rtm = 1;', 'eoptions.interp = 2;', 'eoptions.wrap = [0 0 0];', "eoptions.weight = '';",
    'roptions.which = [0 1];', 'roptions.interp = 4;', 'roptions.wrap = [0 0 0];', 'roptions.mask = 1;', "roptions.prefix = 'r';"
],
    ...
    'spm.spatial.preproc._7': [
        ...
        'channel.biasreg = 0.001;', 'channel.biasfwhm = 60;', 'channel.write = [0 1];', "tissue(1).tpm = {'/home/radon/spm12/tpm/TPM.nii,1'};",
        'tissue(1).ngaus = 1;', 'tissue(1).native = [1 0];', 'tissue(1).warped = [0 0];', "tissue(2).tpm = {'/home/radon/spm12/tpm/TPM.nii,2'};",
        'tissue(2).ngaus = 1;', 'tissue(2).native = [1 0];', 'tissue(2).warped = [0 0];', "tissue(3).tpm = {'/home/radon/spm12/tpm/TPM.nii,3'};",
        'tissue(3).ngaus = 2;', 'tissue(3).native = [1 0];', 'tissue(3).warped = [0 0];', "tissue(4).tpm = {'/home/radon/spm12/tpm/TPM.nii,4'};",
        'tissue(4).ngaus = 3;', 'tissue(4).native = [1 0];', 'tissue(4).warped = [0 0];', "tissue(5).tpm = {'/home/radon/spm12/tpm/TPM.nii,5'};",
        'tissue(5).ngaus = 4;', 'tissue(5).native = [1 0];', 'tissue(5).warped = [0 0];', "tissue(6).tpm = {'/home/radon/spm12/tpm/TPM.nii,6'};",
        'tissue(6).ngaus = 2;', 'tissue(6).native = [0 0];', 'tissue(6).warped = [0 0];', 'warp.mrf = 1;', 'warp.cleanup = 1;', 'warp.reg = [0 0.001 0.5 0.05 0.2];', "warp.affreg = 'mni';",
        'warp.fwhm = 0;', 'warp.samp = 3;', 'warp.write = [0 1];'
],
    ...
    'woptions.bb = [-78 -112 -70 78 76 85];', 'woptions.vox = [2 2 2];', 'woptions.interp = 4;', "woptions.prefix = 'w';"
],
    ...
    'spm.stats.fmri_spec._11': [
        ...
        "timing.units = 'secs';",
        'timing.RT = 2;', 'timing.fmri_t = 16;', 'timing.fmri_t0 = 8;', "sess.scans(1) = cfg_dep('Smooth: Smoothed Images', substruct('.','val', '{}',{10}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));",
        ...
        "sess.multi_reg = {''};",
        'sess.hpf = 128;', "fact = struct('name', {}, 'levels', {});",
        'bases.hrf.derivs = [0 0];', 'volt = 1;', "global = 'None';",
        'mthresh = 0.8;', "mask = {''};",
        "cvi = 'AR(1)';"
],
    ...
    "spmmat(1) = cfg_dep('fMRI model specification: SPM.mat File', substruct('.','val', '{}',{11}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));",
        'write_residuals = 0;', 'method.Classical = 1;'
],
    'spm.stats.con._13': [
        ...
        'consess{1}.tcon.weights = [1 0];', "consess{1}.tcon.sessrep = 'none';",
        'delete = 0;'
],
    'spm.stats.results._14': [
        "spmmat(1) = cfg_dep('Contrast Manager: SPM.mat File', substruct('.','val', '{}',{13}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));",
        "conspec.titlestr = '';",
        'conspec.contrasts = Inf;', "conspec.threshdesc = 'none';",
        'conspec.thresh = 0.001;', 'conspec.extent = 0;', 'conspec.conjunction = 1;', 'conspec.mask.none = 1;', 'units = 1;', "print = 'pdf';",
